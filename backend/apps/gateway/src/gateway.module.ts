...
// Gateway is a multi-concern app (the system's edge) — realtime, auth-proxy, and tool-proxy share
// no models, application logic, or infrastructure, and never call each other, so each is a fully
